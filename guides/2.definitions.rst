...
catpured token text. This text will be passed to its step's corresponding
...
one step following it that is makred cyan.
...
Executing Behat with this feature context will result in a ``Ambigious``

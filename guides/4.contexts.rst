...
Behat will see scenario in your test suite, he will:
...
are the same for Behat. He will find and use methods in them same way
...
will want to make our contexts environment-independant. Where to put
